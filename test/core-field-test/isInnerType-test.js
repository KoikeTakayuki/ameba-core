...
describe('isInnerTypeField', function () {
  ...
  it('should have 8 keys', function () {
    Object.keys(isInnerTypeField).should.have.length(8);
  });

  it('should have keys: [type, id, name, fieldType, isRequired, isListField, defaultValue, validator]', function () {
    isInnerTypeField.should.have.keys('type', 'id', 'name', 'fieldType', 'isRequired', 'isListField', 'defaultValue', 'validator');
  });

...
Module.fields = [CoreField.ParentModule];
Module.traits = [];
...
Trait.fields = [CoreField.Module, CoreField.Fields, CoreField.Traits];
Trait.traits = [];
...
RecordType.fields = [CoreField.BaseType, CoreField.IsInnerType, CoreField.IsPrimitiveType];
RecordType.traits = [];
...
Field.fields = [CoreField.FieldType, CoreField.IsRequired, CoreField.IsListField, CoreField.DefaultValue];
Field.traits = [];
